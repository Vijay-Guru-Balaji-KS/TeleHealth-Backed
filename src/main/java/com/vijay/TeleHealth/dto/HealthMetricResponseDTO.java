...
public class HealthMetricResponseDTO {
	...
	public HealthMetricResponseDTO() {
	}

	public HealthMetricResponseDTO(Long id, Float height, Float weight, String bloodPressure, Integer fastingLvl,
	...
	public String toString() {
		return "HealthMetricResponseDTO [id=" + id + ", height=" + height + ", weight=" + weight + ", bloodPressure="
